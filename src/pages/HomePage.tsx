...
const HomePage = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white">
          ...
          <ScrollReveal direction="up" delay={800}>
            <Button asChild size="lg" className="scroll-bounce">
              <Link to="/booking">
                {t('home.cta')}
              </Link>
            </Button>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Feature 1 */}
            <ScrollReveal direction="up" delay={100}>
              <div className="bg-white p-6 rounded-lg shadow-soft hover-scale feature-card">
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal direction="up">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8">
              ...
              <Link to="/gallery" className="text-marea-600 hover:text-marea-800 font-medium gallery-link">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <ScrollReveal direction="left" delay={100}>
              <div className="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg shadow-soft gallery-item">
                <img 
      ...
      {/* History & Story with Parallax */}
      <ParallaxSection 
        className="py-16" 
        backgroundImage="/images/sailor_background.png" 
        overlay={true}
        speed={0.4}
      >
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <ScrollReveal direction="fade" delay={100}>
              <h2 className="text-3xl font-bold font-serif mb-8 text-center text-white zaratan-title">
                The History of Zaratan
              </h2>
            </ScrollReveal>
            <div className="prose max-w-none mx-auto text-white">
              <ScrollReveal direction="up" delay={200}>
                <p className="mb-4">
              ...
              <ScrollReveal direction="left" delay={500}>
                <blockquote className="italic border-l-4 border-white pl-4 py-2 my-4 bg-white bg-opacity-20 rounded-r-lg ancient-quote">
              ...
              <ScrollReveal direction="fade" delay={600}>
                <p className="text-center text-lg font-serif italic zaratan-question">
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
              ...
              <ScrollReveal direction="left" delay={200}>
                <div className="flex space-x-4">
                  <Button variant="outline" asChild className="location-button">
            ...
            <div className="lg:w-1/2">
              <ScrollReveal direction="right" delay={100}>
                <div className="rounded-lg overflow-hidden shadow-soft map-container">
                  <iframe 
      ...
      <section className="py-16 bg-marea-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <ScrollReveal direction="up">
            <h2 className="text-3xl font-bold font-serif mb-6 cta-title">
          ...
          <ScrollReveal direction="up" delay={200}>
            <Button size="lg" variant="secondary" asChild className="cta-button">
              <Link to="/booking">
                {t('common.bookNow')}
              </Link>
            </Button>
