...
const HomePage = () => {
  ...
  return (
    <>
      ...
      {/* History & Story */}
      <section className="py-16 bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: "url('/images/sailor_background.png')" }}>
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold font-serif mb-8 text-center text-white">
            ...
            <div className="prose max-w-none mx-auto text-white">
              ...
              <blockquote className="italic border-l-4 border-white pl-4 py-2 my-4 bg-white bg-opacity-20 rounded-r-lg">
